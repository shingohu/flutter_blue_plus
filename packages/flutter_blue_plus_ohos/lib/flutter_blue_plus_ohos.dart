...
final class FlutterBluePlusOhos extends FlutterBluePlusPlatform {
  @visibleForTesting
  ...
  static void registerWith() {
    FlutterBluePlusPlatform.instance = FlutterBluePlusOhos();
  }
  ...
  Future<bool> clearGattCache(
    ...
    return await _callOhosMethod<bool>(
      'clearGattCache',
  ...
  Future<BmBluetoothAdapterName> getAdapterName(
    ...
    return BmBluetoothAdapterName(
      adapterName: await _callOhosMethod(
        'getAdapterName',
      ),
    );
  }
